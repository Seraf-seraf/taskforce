...
<div class="table-layout">
    <header class=" page-header--index">
        <div
            class="main-container page-header__container page-header__container--index">
            <div class="page-header__logo--index">
                <a>
                    <svg class="logo-image--index"
                        ...
                        <g>
                            <g>
                                ...
                                <path
                                    ...
                                    transform="translate(-5.5 -7.17)"/>
                                <path
                                    d="M782,12V52c0,6.43,10,6.45,10,0V12c0-6.43-10-6.45-10,0Z"
                                    transform="translate(-5.5 -7.17)"/>
                                <path
    ...
    <main>
        <div class="landing-container">
            <div class="landing-top">
                ...
                <a href="<?= Url::to('/sign-up'); ?>" class="button">Создать
                    аккаунт</a>
            </div>
            <div class="landing-center">
                <div class="landing-instruction">
                    ...
                    <div class="landing-instruction-step">
                        <div
                            class="instruction-circle  circle-discussion"></div>
                        <div class="instruction-description">
